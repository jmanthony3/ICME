...
set timestep [lindex $argv 14]

spawn ./FCCdata
expect " Yes=1(continue), No=2"
send -- "$proceed\r"
expect " 12 = glideloops"
send -- "$data_type\r"
expect " 2) the number and type of source pairs"
send -- "2\r"
expect " 4) Only Arms"
send -- "1\r"
...
expect " a paired Frank-Read sources, in units of b"
send -- "$max_sep\r"
expect " 5) Randomly select a plane in the {111} family"
send -- "$glide_plane\r"
