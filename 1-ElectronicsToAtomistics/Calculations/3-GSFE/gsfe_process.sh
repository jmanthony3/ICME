...
set -x
lattice_area=$(echo "$LATTICE_PARAMETER*$LATTICE_PARAMETER" | bc -l) # angstrom^2
...
cp "EvsA" "../3-GSFE/EvsA"
cp "EvsV" "../3-GSFE/EvsV"
cp "SUMMARY" "../3-GSFE/SUMMARY"
python3 "EvA_EvV_plot.py" # generate plots
cp "Name_of_EvA.pdf" "../3-GSFE/Name_of_EvA.pdf"
cp "Name_of_EvV.pdf" "../3-GSFE/Name_of_EvV.pdf"
cp "Name_of_Combined.pdf" "../3-GSFE/Name_of_Combined.pdf"
...
cp "output_gens/gsfe_"*".out" "../0-Scripts"
...
cp "GSFE_SUMMARY" "../3-GSFE/GSFE_SUMMARY"
