...
sed -i "s%^incrmt = [[:alpha:]]*.*[[:alpha:]]*%incrmt = ${STRAIN_INCREMENT[0]}%" \
    "./rve.single.inp"
sed -i "s%^rate   = [[:alpha:]]*.*[[:alpha:]]*%rate   = ${STRAIN_RATE[0]}%" \
    "./rve.single.inp"
sed -i "s%^strain = [[:alpha:]]*.*[[:alpha:]]*%strain = ${STRAIN[0]}%" \
    "./rve.single.inp"
...
sed -i "7828s%^      RATE = 0.0001D-00%      RATE = ${STRAIN_RATE[0]}D-00%" \
    "./umat_xtal.f"
...
# modify `rve.single.inp` with variables
sed -i "s%^incrmt = [[:alpha:]]*.*[[:alpha:]]*%incrmt = ${STRAIN_INCREMENT[1]}%" \
    "./rve.single.inp"
sed -i "s%^rate   = [[:alpha:]]*.*[[:alpha:]]*%rate   = ${STRAIN_RATE[1]}%" \
    "./rve.single.inp"
sed -i "s%^strain = [[:alpha:]]*.*[[:alpha:]]*%strain = ${STRAIN[1]}%" \
    "./rve.single.inp"
...
# modify `umat_xtal.f` with `PWD` and strain rate
sed -i "95s%^[[:print:]]*%     \&    /'$PWD'/%" "./umat_xtal.f"
sed -i "7828s%^      RATE = 0.0001D-00%      RATE = ${STRAIN_RATE[1]}D-00%" \
    "./umat_xtal.f"
...
# modify `rve.single.inp` with variables
sed -i "s%^incrmt = [[:alpha:]]*.*[[:alpha:]]*%incrmt = ${STRAIN_INCREMENT[2]}%" \
    "./rve.single.inp"
sed -i "s%^rate   = [[:alpha:]]*.*[[:alpha:]]*%rate   = ${STRAIN_RATE[2]}%" \
    "./rve.single.inp"
sed -i "s%^strain = [[:alpha:]]*.*[[:alpha:]]*%strain = ${STRAIN[2]}%" \
    "./rve.single.inp"
